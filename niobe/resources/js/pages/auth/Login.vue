...
<template>
    ...
    >
        ...
        <a
            ...
            class="oauth-btn mb-4 w-full border-gray-300! bg-white! text-black! hover:bg-white! hover:text-black! dark:bg-white! dark:text-black!"
        >
            <div class="flex flex-row items-center justify-center">
                <img
                    ...
                    class="mr-3 h-6 w-6"
                />
                <span class="mt-1 text-center font-semibold text-black">Continue with Google</span>
            </div>
        </a>
